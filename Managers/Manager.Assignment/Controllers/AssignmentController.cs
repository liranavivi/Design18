...
public class AssignmentController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<AssignmentEntity>>> GetAll()
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Assignment entities. User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<object>> GetPaged([FromQuery] int page = 1, [FromQuery] int pageSize = 10)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved paged Assignment entities. Page: {Page}/{TotalPages}, PageSize: {PageSize}, TotalCount: {TotalCount}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<AssignmentEntity>> GetById(string id)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved Assignment entity. Id: {Id}, Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, User: {User}, RequestId: {RequestId}",
                entity.Id, entity.Version, entity.Name, entity.StepId, entity.EntityIds?.Count ?? 0, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<AssignmentEntity>> GetByCompositeKey(string version, string name)
    {
        ...
        _logger.LogInformation("Starting GetByCompositeKey Assignment request. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            if (entity == null)
            {
                _logger.LogWarning("Assignment entity not found by composite key. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                    version, name, compositeKey, userContext, HttpContext.TraceIdentifier);
                return NotFound($"Assignment entity with version '{version}' and name '{name}' not found");
            }

            _logger.LogInformation("Successfully retrieved Assignment entity by composite key. CompositeKey: {CompositeKey}, Id: {Id}, Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Assignment entity by composite key. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                version, name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving the Assignment entity");
        }
    }
    ...
    public async Task<ActionResult<IEnumerable<AssignmentEntity>>> GetByStepId(string stepId)
    {
        ...
        {
            _logger.LogWarning("Invalid GUID format provided for GetByStepId. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Assignment entities by step ID. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Assignment entities by step ID. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
                guidStepId, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving Assignment entities");
        }
    }
    ...
    public async Task<ActionResult<IEnumerable<AssignmentEntity>>> GetByEntityId(string entityId)
    {
        ...
        {
            _logger.LogWarning("Invalid GUID format provided for GetByEntityId. EntityId: {EntityId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Assignment entities by entity ID. EntityId: {EntityId}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<bool>> CheckEntityExists(string entityId)
    {
        ...
        if (!Guid.TryParse(entityId, out Guid guidEntityId))
        {
            _logger.LogWarning("Invalid GUID format provided for CheckEntityExists. EntityId: {EntityId}, User: {User}, RequestId: {RequestId}",
                entityId, userContext, HttpContext.TraceIdentifier);
            return BadRequest($"Invalid GUID format: {entityId}");
        }

        _logger.LogInformation("Starting CheckEntityExists Assignment request. EntityId: {EntityId}, User: {User}, RequestId: {RequestId}",
            guidEntityId, userContext, HttpContext.TraceIdentifier);
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully checked entity references. EntityId: {EntityId}, HasReferences: {HasReferences}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error occurred while checking entity references. EntityId: {EntityId}, User: {User}, RequestId: {RequestId}",
                guidEntityId, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<bool>> CheckStepReferences(string stepId)
    {
        ...
        if (!Guid.TryParse(stepId, out Guid guidStepId))
        {
            _logger.LogWarning("Invalid GUID format provided for CheckStepReferences. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
                stepId, userContext, HttpContext.TraceIdentifier);
            return BadRequest($"Invalid GUID format: {stepId}");
        }

        _logger.LogInformation("Starting CheckStepReferences Assignment request. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
            guidStepId, userContext, HttpContext.TraceIdentifier);
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully checked step references. StepId: {StepId}, HasReferences: {HasReferences}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error checking step references. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
                guidStepId, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<IEnumerable<AssignmentEntity>>> GetByVersion(string version)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Assignment entities by version. Version: {Version}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<IEnumerable<AssignmentEntity>>> GetByName(string name)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Assignment entities by name. Name: {Name}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<AssignmentEntity>> Create([FromBody] AssignmentEntity entity)
    {
        ...
        _logger.LogInformation("Starting Create Assignment request. CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for Assignment creation. User: {User}, RequestId: {RequestId}",
                userContext, HttpContext.TraceIdentifier);
        ...
        if (!ModelState.IsValid)
        {
            ...
            _logger.LogWarning("Invalid model state for Assignment creation. Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogDebug("Validating step reference before creating Assignment entity. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogDebug("Validating entity references before creating Assignment entity. EntityIds: {EntityIds}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogDebug("All validations passed. Creating Assignment entity with details. Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, CreatedBy: {CreatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            {
                _logger.LogError("MongoDB failed to generate ID for new AssignmentEntity. Version: {Version}, Name: {Name}, User: {User}, RequestId: {RequestId}",
                    entity.Version, entity.Name, userContext, HttpContext.TraceIdentifier);
                return StatusCode(500, "Failed to generate entity ID");
            }

            _logger.LogInformation("Successfully created Assignment entity. Id: {Id}, Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Step validation failed creating Assignment entity. StepId: {StepId}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Entity validation failed creating Assignment entity. EntityIds: {EntityIds}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict creating Assignment entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error creating Assignment entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<AssignmentEntity>> Update(string id, [FromBody] AssignmentEntity entity)
    {
        ...
        _logger.LogInformation("Starting Update Assignment request. Id: {Id}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            guidId, compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for Assignment update. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);
            return BadRequest("Assignment entity cannot be null");
        }
        ...
        if (guidId != entity.Id)
        {
            _logger.LogWarning("ID mismatch in Assignment update request. URL ID: {UrlId}, Entity ID: {EntityId}, User: {User}, RequestId: {RequestId}",
        ...
        if (!ModelState.IsValid)
        {
            var errors = ModelState.Values.SelectMany(v => v.Errors).Select(e => e.ErrorMessage);
            var errorMessage = string.Join("; ", errors);
            _logger.LogWarning("Invalid model state for Assignment update. Id: {Id}, Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            {
                _logger.LogInformation("Checking referential integrity for Assignment update (ID change). Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                ...
                {
                    _logger.LogWarning("Cannot update assignment ID - referenced by OrchestratedFlow entities. Id: {Id}, User: {User}, RequestId: {RequestId}",
                        guidId, userContext, HttpContext.TraceIdentifier);
            ...
            _logger.LogDebug("Validating step reference before updating Assignment entity. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
                entity.StepId, userContext, HttpContext.TraceIdentifier);

            await _assignmentValidator.ValidateStepExists(entity.StepId);

            // Validate entity IDs exist before updating the entity
            _logger.LogDebug("Validating entity references before updating Assignment entity. EntityIds: {EntityIds}, User: {User}, RequestId: {RequestId}",
                string.Join(",", entity.EntityIds), userContext, HttpContext.TraceIdentifier);
            ...
            _logger.LogDebug("All validations passed. Updating Assignment entity with details. Id: {Id}, Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, UpdatedBy: {UpdatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogInformation("Successfully updated Assignment entity. Id: {Id}, Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Step validation failed updating Assignment entity. Id: {Id}, StepId: {StepId}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Entity validation failed updating Assignment entity. Id: {Id}, EntityIds: {EntityIds}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict updating Assignment entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error updating Assignment entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult> Delete(string id)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Checking referential integrity for Assignment deletion. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);

            var hasOrchestratedFlowReferences = await _orchestratedFlowValidationService.CheckAssignmentReferencesAsync(guidId);
            if (hasOrchestratedFlowReferences)
            {
                _logger.LogWarning("Cannot delete assignment - referenced by OrchestratedFlow entities. Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                return Conflict("Cannot delete assignment: it is referenced by one or more OrchestratedFlow entities");
            }

            _logger.LogDebug("Deleting Assignment entity. Id: {Id}, Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogInformation("Successfully deleted Assignment entity. Id: {Id}, Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, User: {User}, RequestId: {RequestId}",
                guidId, existingEntity.Version, existingEntity.Name, existingEntity.StepId, existingEntity.EntityIds?.Count ?? 0, userContext, HttpContext.TraceIdentifier);
