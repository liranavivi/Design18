...
public class CreateAssignmentCommandConsumer : IConsumer<CreateAssignmentCommand>
{
    ...
    public async Task Consume(ConsumeContext<CreateAssignmentCommand> context)
    {
        ...
        _logger.LogInformation("Processing CreateAssignmentCommand. Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, RequestedBy: {RequestedBy}",
        ...
        try
        {
            ...
            stopwatch.Stop();
            _logger.LogInformation("Successfully processed CreateAssignmentCommand. Id: {Id}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing CreateAssignmentCommand. Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, Duration: {Duration}ms",
