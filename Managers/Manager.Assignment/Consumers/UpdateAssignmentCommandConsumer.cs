...
public class UpdateAssignmentCommandConsumer : IConsumer<UpdateAssignmentCommand>
{
    ...
    public async Task Consume(ConsumeContext<UpdateAssignmentCommand> context)
    {
        ...
        _logger.LogInformation("Processing UpdateAssignmentCommand. Id: {Id}, Version: {Version}, Name: {Name}, StepId: {StepId}, EntityIds count: {EntityIdsCount}, RequestedBy: {RequestedBy}",
        ...
        try
        {
            ...
            {
                _logger.LogWarning("Assignment entity not found for update. Id: {Id}", command.Id);
            ...
            stopwatch.Stop();
            _logger.LogInformation("Successfully processed UpdateAssignmentCommand. Id: {Id}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing UpdateAssignmentCommand. Id: {Id}, Duration: {Duration}ms",
