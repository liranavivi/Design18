...
public class UpdateStepCommandConsumer : IConsumer<UpdateStepCommand>
{
    ...
    public async Task Consume(ConsumeContext<UpdateStepCommand> context)
    {
        ...
        _logger.LogInformation("Processing UpdateStepCommand. Id: {Id}, Version: {Version}, Name: {Name}, ProcessorId: {ProcessorId}, NextStepIds: {NextStepIds}, EntryCondition: {EntryCondition}, RequestedBy: {RequestedBy}",
        ...
        try
        {
            ...
            {
                _logger.LogWarning("Step entity not found for update. Id: {Id}", command.Id);
            ...
            stopwatch.Stop();
            _logger.LogInformation("Successfully processed UpdateStepCommand. Id: {Id}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing UpdateStepCommand. Id: {Id}, Duration: {Duration}ms",
