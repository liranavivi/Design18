...
public class StepController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<StepEntity>>> GetAll()
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Step entities. User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<object>> GetPaged([FromQuery] int page = 1, [FromQuery] int pageSize = 10)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved paged Step entities. Page: {Page}/{TotalPages}, PageSize: {PageSize}, TotalCount: {TotalCount}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<StepEntity>> GetById(string id)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved Step entity. Id: {Id}, Version: {Version}, Name: {Name}, ProcessorId: {ProcessorId}, NextStepIds: {NextStepIds}, EntryCondition: {EntryCondition}, User: {User}, RequestId: {RequestId}",
                entity.Id, entity.Version, entity.Name, entity.ProcessorId, string.Join(",", entity.NextStepIds), entity.EntryCondition, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<StepEntity>> GetByCompositeKey(string version, string name)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved Step entity by composite key. CompositeKey: {CompositeKey}, Id: {Id}, Version: {Version}, Name: {Name}, ProcessorId: {ProcessorId}, NextStepIds: {NextStepIds}, EntryCondition: {EntryCondition}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<IEnumerable<StepEntity>>> GetByProcessorId(string processorId)
    {
        ...
        {
            _logger.LogWarning("Invalid GUID format for ProcessorId. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Step entities by ProcessorId. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Step entities by ProcessorId. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
                guidProcessorId, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving Step entities");
        }
    }
    ...
    public async Task<ActionResult<bool>> CheckProcessorReferences(string processorId)
    {
        ...
        if (!Guid.TryParse(processorId, out var guidProcessorId))
        {
            _logger.LogWarning("Invalid GUID format for ProcessorId in reference check. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
                processorId, userContext, HttpContext.TraceIdentifier);
            return BadRequest($"Invalid GUID format: {processorId}");
        }

        _logger.LogInformation("Starting CheckProcessorReferences request. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
            guidProcessorId, userContext, HttpContext.TraceIdentifier);
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully processed CheckProcessorReferences request. ProcessorId: {ProcessorId}, HasReferences: {HasReferences}, Count: {Count}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error processing CheckProcessorReferences request. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
                guidProcessorId, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<IEnumerable<StepEntity>>> GetByNextStepId(string stepId)
    {
        ...
        {
            _logger.LogWarning("Invalid GUID format for StepId. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
                stepId, userContext, HttpContext.TraceIdentifier);
            return BadRequest($"Invalid GUID format: {stepId}");
        }

        _logger.LogInformation("Starting GetByNextStepId Step request. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Step entities that reference StepId. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Step entities by NextStepId. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
                guidStepId, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving Step entities");
        }
    }
    ...
    public async Task<ActionResult<IEnumerable<StepEntity>>> GetByEntryCondition(string condition)
    {
        ...
        {
            _logger.LogWarning("Invalid EntryCondition format. Condition: {Condition}, User: {User}, RequestId: {RequestId}",
        ...
        _logger.LogInformation("Starting GetByEntryCondition Step request. EntryCondition: {EntryCondition}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Step entities by EntryCondition. EntryCondition: {EntryCondition}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Step entities by EntryCondition. EntryCondition: {EntryCondition}, User: {User}, RequestId: {RequestId}",
                entryCondition, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving Step entities");
        }
    }
    ...
    public async Task<ActionResult<bool>> CheckStepExists(string stepId)
    {
        ...
        if (!Guid.TryParse(stepId, out var guidStepId))
        {
            _logger.LogWarning("Invalid GUID format for StepId in exists check. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
                stepId, userContext, HttpContext.TraceIdentifier);
            return BadRequest($"Invalid GUID format: {stepId}");
        }

        _logger.LogInformation("Starting CheckStepExists request. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
            guidStepId, userContext, HttpContext.TraceIdentifier);
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully processed CheckStepExists request. StepId: {StepId}, Exists: {Exists}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error processing CheckStepExists request. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
                guidStepId, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while processing the request");
        }
    }
    ...
    public async Task<ActionResult<IEnumerable<StepEntity>>> GetByVersion(string version)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Step entities by version. Version: {Version}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<IEnumerable<StepEntity>>> GetByName(string name)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Step entities by name. Name: {Name}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<StepEntity>> Create([FromBody] StepEntity entity)
    {
        ...
        _logger.LogInformation("Starting Create Step request. CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for Step creation. User: {User}, RequestId: {RequestId}",
                userContext, HttpContext.TraceIdentifier);
        ...
        if (!ModelState.IsValid)
        {
            ...
            _logger.LogWarning("Invalid model state for Step creation. Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogDebug("Validating processor reference before creating Step entity. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogDebug("Validating next step references before creating Step entity. NextStepIds: {NextStepIds}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogDebug("All validations passed. Creating Step entity with details. Version: {Version}, Name: {Name}, ProcessorId: {ProcessorId}, NextStepIds: {NextStepIds}, EntryCondition: {EntryCondition}, CreatedBy: {CreatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            {
                _logger.LogError("MongoDB failed to generate ID for new StepEntity. Version: {Version}, Name: {Name}, User: {User}, RequestId: {RequestId}",
                    entity.Version, entity.Name, userContext, HttpContext.TraceIdentifier);
                return StatusCode(500, "Failed to generate entity ID");
            }

            _logger.LogInformation("Successfully created Step entity. Id: {Id}, Version: {Version}, Name: {Name}, ProcessorId: {ProcessorId}, NextStepIds: {NextStepIds}, EntryCondition: {EntryCondition}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Processor validation failed creating Step entity. ProcessorId: {ProcessorId}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Next step validation failed creating Step entity. NextStepIds: {NextStepIds}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict creating Step entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error creating Step entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<StepEntity>> Update(string id, [FromBody] StepEntity entity)
    {
        ...
        _logger.LogInformation("Starting Update Step request. Id: {Id}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            guidId, compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for Step update. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);
            return BadRequest("Step entity cannot be null");
        }
        ...
        if (guidId != entity.Id)
        {
            _logger.LogWarning("ID mismatch in Step update request. URL ID: {UrlId}, Entity ID: {EntityId}, User: {User}, RequestId: {RequestId}",
        ...
        if (!ModelState.IsValid)
        {
            var errors = ModelState.Values.SelectMany(v => v.Errors).Select(e => e.ErrorMessage);
            var errorMessage = string.Join("; ", errors);
            _logger.LogWarning("Invalid model state for Step update. Id: {Id}, Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogDebug("Validating processor reference before updating Step entity. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
                entity.ProcessorId, userContext, HttpContext.TraceIdentifier);

            await _processorValidator.ValidateProcessorExists(entity.ProcessorId);

            // Validate next step IDs exist before updating the entity
            _logger.LogDebug("Validating next step references before updating Step entity. NextStepIds: {NextStepIds}, User: {User}, RequestId: {RequestId}",
                string.Join(",", entity.NextStepIds), userContext, HttpContext.TraceIdentifier);
            ...
            _logger.LogDebug("All validations passed. Updating Step entity with details. Id: {Id}, Version: {Version}, Name: {Name}, ProcessorId: {ProcessorId}, NextStepIds: {NextStepIds}, EntryCondition: {EntryCondition}, UpdatedBy: {UpdatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogInformation("Successfully updated Step entity. Id: {Id}, Version: {Version}, Name: {Name}, ProcessorId: {ProcessorId}, NextStepIds: {NextStepIds}, EntryCondition: {EntryCondition}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Processor validation failed updating Step entity. Id: {Id}, ProcessorId: {ProcessorId}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Next step validation failed updating Step entity. Id: {Id}, NextStepIds: {NextStepIds}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict updating Step entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error updating Step entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult> Delete(string id)
    {
        ...
        try
        {
            ...
            _logger.LogDebug("Deleting Step entity. Id: {Id}, Version: {Version}, Name: {Name}, ProcessorId: {ProcessorId}, NextStepIds: {NextStepIds}, EntryCondition: {EntryCondition}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogInformation("Successfully deleted Step entity. Id: {Id}, Version: {Version}, Name: {Name}, ProcessorId: {ProcessorId}, NextStepIds: {NextStepIds}, EntryCondition: {EntryCondition}, User: {User}, RequestId: {RequestId}",
                guidId, existingEntity.Version, existingEntity.Name, existingEntity.ProcessorId, string.Join(",", existingEntity.NextStepIds), existingEntity.EntryCondition, userContext, HttpContext.TraceIdentifier);
