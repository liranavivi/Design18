...
public class CreateWorkflowCommandConsumer : IConsumer<CreateWorkflowCommand>
{
    ...
    public async Task Consume(ConsumeContext<CreateWorkflowCommand> context)
    {
        ...
        _logger.LogInformation("Processing CreateWorkflowCommand. Version: {Version}, Name: {Name}, StepIds: {StepIds}, RequestedBy: {RequestedBy}",
        ...
        try
        {
            ...
            stopwatch.Stop();
            _logger.LogInformation("Successfully processed CreateWorkflowCommand. Id: {Id}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing CreateWorkflowCommand. Version: {Version}, Name: {Name}, StepIds: {StepIds}, Duration: {Duration}ms",
