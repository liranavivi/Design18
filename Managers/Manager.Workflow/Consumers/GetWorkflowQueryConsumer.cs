...
public class GetWorkflowQueryConsumer : IConsumer<GetWorkflowQuery>
{
    ...
    public async Task Consume(ConsumeContext<GetWorkflowQuery> context)
    {
        ...
        _logger.LogInformation("Processing GetWorkflowQuery. Id: {Id}, CompositeKey: {CompositeKey}",
        ...
        try
        {
            ...
            if (entity != null)
            {
                _logger.LogInformation("Successfully processed GetWorkflowQuery. Found entity Id: {Id}, Duration: {Duration}ms",
            ...
            {
                _logger.LogInformation("Workflow entity not found. Id: {Id}, CompositeKey: {CompositeKey}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing GetWorkflowQuery. Id: {Id}, CompositeKey: {CompositeKey}, Duration: {Duration}ms",
                query.Id, query.CompositeKey, stopwatch.ElapsedMilliseconds);
