...
public class UpdateWorkflowCommandConsumer : IConsumer<UpdateWorkflowCommand>
{
    ...
    public async Task Consume(ConsumeContext<UpdateWorkflowCommand> context)
    {
        ...
        _logger.LogInformation("Processing UpdateWorkflowCommand. Id: {Id}, Version: {Version}, Name: {Name}, StepIds: {StepIds}, RequestedBy: {RequestedBy}",
        ...
        try
        {
            ...
            {
                _logger.LogWarning("Workflow entity not found for update. Id: {Id}", command.Id);
            ...
            stopwatch.Stop();
            _logger.LogInformation("Successfully processed UpdateWorkflowCommand. Id: {Id}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing UpdateWorkflowCommand. Id: {Id}, Duration: {Duration}ms",
