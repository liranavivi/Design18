...
public class WorkflowController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<WorkflowEntity>>> GetAll()
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Workflow entities. User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving all Workflow entities. User: {User}, RequestId: {RequestId}",
                userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<object>> GetPaged([FromQuery] int page = 1, [FromQuery] int pageSize = 10)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved paged Workflow entities. Page: {Page}/{TotalPages}, PageSize: {PageSize}, TotalCount: {TotalCount}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving paged Workflow entities. Page: {Page}, PageSize: {PageSize}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<WorkflowEntity>> GetById(string id)
    {
        ...
        _logger.LogInformation("Starting GetById Workflow request. Id: {Id}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            if (entity == null)
            {
                _logger.LogWarning("Workflow entity not found. Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                return NotFound($"Workflow entity with ID {guidId} not found");
            }

            _logger.LogInformation("Successfully retrieved Workflow entity. Id: {Id}, Version: {Version}, Name: {Name}, StepIds: {StepIds}, User: {User}, RequestId: {RequestId}",
                entity.Id, entity.Version, entity.Name, string.Join(",", entity.StepIds), userContext, HttpContext.TraceIdentifier);

            return Ok(entity);
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error retrieving Workflow entity by ID. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<WorkflowEntity>> GetByCompositeKey(string version, string name)
    {
        ...
        _logger.LogInformation("Starting GetByCompositeKey Workflow request. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            if (entity == null)
            {
                _logger.LogWarning("Workflow entity not found by composite key. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                    version, name, compositeKey, userContext, HttpContext.TraceIdentifier);
                return NotFound($"Workflow entity with version '{version}' and name '{name}' not found");
            }

            _logger.LogInformation("Successfully retrieved Workflow entity by composite key. CompositeKey: {CompositeKey}, Id: {Id}, Version: {Version}, Name: {Name}, StepIds: {StepIds}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Workflow entity by composite key. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                version, name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving the Workflow entity");
        }
    }
    ...
    public async Task<ActionResult<IEnumerable<WorkflowEntity>>> GetByStepId(string stepId)
    {
        ...
        _logger.LogInformation("Starting GetByStepId Workflow request. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Workflow entities by stepId. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Workflow entities by stepId. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
                guidStepId, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving Workflow entities");
        }
    }
    ...
    public async Task<ActionResult<bool>> CheckStepReferences(string stepId)
    {
        ...
        _logger.LogInformation("Starting CheckStepReferences Workflow request. StepId: {StepId}, User: {User}, RequestId: {RequestId}",
            guidStepId, userContext, HttpContext.TraceIdentifier);
    ...
    {
        var userContext = User.Identity?.Name ?? "Anonymous";
        _logger.LogInformation("Starting GetByVersion Workflow request. Version: {Version}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Workflow entities by version. Version: {Version}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Workflow entities by version. Version: {Version}, User: {User}, RequestId: {RequestId}",
                version, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving Workflow entities");
        }
    }
    ...
    {
        var userContext = User.Identity?.Name ?? "Anonymous";
        _logger.LogInformation("Starting GetByName Workflow request. Name: {Name}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Workflow entities by name. Name: {Name}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Workflow entities by name. Name: {Name}, User: {User}, RequestId: {RequestId}",
                name, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving Workflow entities");
        }
    }
    ...
    public async Task<ActionResult<WorkflowEntity>> Create([FromBody] WorkflowEntity entity)
    {
        ...
        _logger.LogInformation("Starting Create Workflow request. CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for Workflow creation. User: {User}, RequestId: {RequestId}",
                userContext, HttpContext.TraceIdentifier);
        ...
        if (!ModelState.IsValid)
        {
            ...
            _logger.LogWarning("Invalid model state for Workflow creation. Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogDebug("Validating step references before creating Workflow entity. StepIds: {StepIds}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogDebug("All validations passed. Creating Workflow entity with details. Version: {Version}, Name: {Name}, StepIds: {StepIds}, CreatedBy: {CreatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            {
                _logger.LogError("MongoDB failed to generate ID for new WorkflowEntity. Version: {Version}, Name: {Name}, User: {User}, RequestId: {RequestId}",
                    entity.Version, entity.Name, userContext, HttpContext.TraceIdentifier);
                return StatusCode(500, "Failed to generate entity ID");
            }

            _logger.LogInformation("Successfully created Workflow entity. Id: {Id}, Version: {Version}, Name: {Name}, StepIds: {StepIds}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Step validation failed creating Workflow entity. StepIds: {StepIds}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict creating Workflow entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error creating Workflow entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<WorkflowEntity>> Update(string id, [FromBody] WorkflowEntity entity)
    {
        ...
        _logger.LogInformation("Starting Update Workflow request. Id: {Id}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            guidId, compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for Workflow update. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);
            return BadRequest("Workflow entity cannot be null");
        }
        ...
        if (guidId != entity.Id)
        {
            _logger.LogWarning("ID mismatch in Workflow update request. URL ID: {UrlId}, Entity ID: {EntityId}, User: {User}, RequestId: {RequestId}",
        ...
        if (!ModelState.IsValid)
        {
            var errors = ModelState.Values.SelectMany(v => v.Errors).Select(e => e.ErrorMessage);
            var errorMessage = string.Join("; ", errors);
            _logger.LogWarning("Invalid model state for Workflow update. Id: {Id}, Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            {
                _logger.LogWarning("Workflow entity not found for update. Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                return NotFound($"Workflow entity with ID {guidId} not found");
            }
            ...
            {
                _logger.LogInformation("Checking referential integrity for Workflow update (ID change). Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                ...
                {
                    _logger.LogWarning("Cannot update workflow ID - referenced by OrchestratedFlow entities. Id: {Id}, User: {User}, RequestId: {RequestId}",
                        guidId, userContext, HttpContext.TraceIdentifier);
            ...
            _logger.LogDebug("Validating step references before updating Workflow entity. StepIds: {StepIds}, User: {User}, RequestId: {RequestId}",
                string.Join(",", entity.StepIds), userContext, HttpContext.TraceIdentifier);
            ...
            _logger.LogDebug("All validations passed. Updating Workflow entity with details. Id: {Id}, Version: {Version}, Name: {Name}, StepIds: {StepIds}, UpdatedBy: {UpdatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogInformation("Successfully updated Workflow entity. Id: {Id}, Version: {Version}, Name: {Name}, StepIds: {StepIds}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Step validation failed updating Workflow entity. Id: {Id}, StepIds: {StepIds}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict updating Workflow entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error updating Workflow entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult> Delete(string id)
    {
        ...
        _logger.LogInformation("Starting Delete Workflow request. Id: {Id}, User: {User}, RequestId: {RequestId}",
            guidId, userContext, HttpContext.TraceIdentifier);
        ...
        try
        {
            ...
            if (existingEntity == null)
            {
                _logger.LogWarning("Workflow entity not found for deletion. Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                return NotFound($"Workflow entity with ID {guidId} not found");
            }

            // Check referential integrity with OrchestratedFlow entities
            _logger.LogInformation("Checking referential integrity for Workflow deletion. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);

            var hasOrchestratedFlowReferences = await _orchestratedFlowValidationService.CheckWorkflowReferencesAsync(guidId);
            if (hasOrchestratedFlowReferences)
            {
                _logger.LogWarning("Cannot delete workflow - referenced by OrchestratedFlow entities. Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                return Conflict("Cannot delete workflow: it is referenced by one or more OrchestratedFlow entities");
            }

            _logger.LogDebug("Deleting Workflow entity. Id: {Id}, Version: {Version}, Name: {Name}, StepIds: {StepIds}, User: {User}, RequestId: {RequestId}",
            ...
            if (!success)
            {
                _logger.LogError("Failed to delete Workflow entity. Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                return StatusCode(500, "Failed to delete Workflow entity");
            }

            _logger.LogInformation("Successfully deleted Workflow entity. Id: {Id}, Version: {Version}, Name: {Name}, StepIds: {StepIds}, User: {User}, RequestId: {RequestId}",
                guidId, existingEntity.Version, existingEntity.Name, string.Join(",", existingEntity.StepIds), userContext, HttpContext.TraceIdentifier);
        ...
        {
            _logger.LogError(ex, "Error deleting Workflow entity. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);
