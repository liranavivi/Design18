...
public class CreateDeliveryCommandConsumer : IConsumer<CreateDeliveryCommand>
{
    ...
    public async Task Consume(ConsumeContext<CreateDeliveryCommand> context)
    {
        ...
        _logger.LogInformation("Processing CreateDeliveryCommand. Version: {Version}, Name: {Name}, Payload: {Payload}, RequestedBy: {RequestedBy}",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing CreateDeliveryCommand. Version: {Version}, Name: {Name}, Payload: {Payload}, Duration: {Duration}ms",
