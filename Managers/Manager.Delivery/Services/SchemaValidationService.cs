...
public class SchemaValidationService : ISchemaValidationService
{
    ...
    public async Task ValidateSchemaExists(Guid schemaId)
    {
        ...
        {
            _logger.LogDebug("Schema validation is disabled. Skipping validation for SchemaId: {SchemaId}", schemaId);
            return;
        }
        ...
        _logger.LogDebug("Validating schema exists. SchemaId: {SchemaId}", schemaId);
        ...
        try
        {
            ...
            _logger.LogDebug("Schema validation passed. SchemaId: {SchemaId}", schemaId);
        }
        ...
        {
            _logger.LogError(ex, "Schema validation failed due to unexpected error. SchemaId: {SchemaId}", schemaId);
