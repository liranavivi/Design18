...
public class ProcessorController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<ProcessorEntity>>> GetAll()
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Processor entities. User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<object>> GetPaged([FromQuery] int page = 1, [FromQuery] int pageSize = 10)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved paged Processor entities. Page: {Page}/{TotalPages}, PageSize: {PageSize}, TotalCount: {TotalCount}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<ProcessorEntity>> GetById(string id)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved Processor entity. Id: {Id}, Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<ProcessorEntity>> GetByCompositeKey(string version, string name)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved Processor entity by composite key. CompositeKey: {CompositeKey}, Id: {Id}, Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<IEnumerable<ProcessorEntity>>> GetByInputSchemaId(string inputSchemaId)
    {
        ...
        {
            _logger.LogWarning("Invalid GUID format provided for input schema ID. InputSchemaId: {InputSchemaId}, User: {User}, RequestId: {RequestId}",
                inputSchemaId, userContext, HttpContext.TraceIdentifier);
            return BadRequest($"Invalid GUID format: {inputSchemaId}");
        }

        _logger.LogInformation("Starting GetByInputSchemaId Processor request. InputSchemaId: {InputSchemaId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Processor entities by input schema ID. InputSchemaId: {InputSchemaId}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Processor entities by input schema ID. InputSchemaId: {InputSchemaId}, User: {User}, RequestId: {RequestId}",
                guidInputSchemaId, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving Processor entities");
        }
    }
    ...
    public async Task<ActionResult<IEnumerable<ProcessorEntity>>> GetByOutputSchemaId(string outputSchemaId)
    {
        ...
        {
            _logger.LogWarning("Invalid GUID format provided for output schema ID. OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
                outputSchemaId, userContext, HttpContext.TraceIdentifier);
            return BadRequest($"Invalid GUID format: {outputSchemaId}");
        }

        _logger.LogInformation("Starting GetByOutputSchemaId Processor request. OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Processor entities by output schema ID. OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving Processor entities by output schema ID. OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
                guidOutputSchemaId, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving Processor entities");
        }
    }
    ...
    public async Task<ActionResult<IEnumerable<ProcessorEntity>>> GetByVersion(string version)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Processor entities by version. Version: {Version}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<IEnumerable<ProcessorEntity>>> GetByName(string name)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} Processor entities by name. Name: {Name}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<ProcessorEntity>> Create([FromBody] ProcessorEntity entity)
    {
        ...
        _logger.LogInformation("Starting Create Processor request. CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for Processor creation. User: {User}, RequestId: {RequestId}",
                userContext, HttpContext.TraceIdentifier);
        ...
        if (!ModelState.IsValid)
        {
            ...
            _logger.LogWarning("Invalid model state for Processor creation. Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogDebug("Validating schema references before creating Processor entity. InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogDebug("Schema validation passed. Creating Processor entity with details. Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, CreatedBy: {CreatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            {
                _logger.LogError("MongoDB failed to generate ID for new ProcessorEntity. Version: {Version}, Name: {Name}, User: {User}, RequestId: {RequestId}",
                    entity.Version, entity.Name, userContext, HttpContext.TraceIdentifier);
                return StatusCode(500, "Failed to generate entity ID");
            }

            _logger.LogInformation("Successfully created Processor entity. Id: {Id}, Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Schema validation failed creating Processor entity. InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict creating Processor entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error creating Processor entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<ProcessorEntity>> Update(string id, [FromBody] ProcessorEntity entity)
    {
        ...
        _logger.LogInformation("Starting Update Processor request. Id: {Id}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            guidId, compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for Processor update. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);
            return BadRequest("Processor entity cannot be null");
        }
        ...
        if (guidId != entity.Id)
        {
            _logger.LogWarning("ID mismatch in Processor update request. URL ID: {UrlId}, Entity ID: {EntityId}, User: {User}, RequestId: {RequestId}",
        ...
        if (!ModelState.IsValid)
        {
            var errors = ModelState.Values.SelectMany(v => v.Errors).Select(e => e.ErrorMessage);
            var errorMessage = string.Join("; ", errors);
            _logger.LogWarning("Invalid model state for Processor update. Id: {Id}, Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            {
                _logger.LogWarning("Processor update blocked due to step references. Id: {Id}, Message: {Message}, User: {User}, RequestId: {RequestId}",
            ...
            {
                _logger.LogError(ex, "Processor reference validation failed during update. Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
            ...
            _logger.LogDebug("Validating schema references before updating Processor entity. InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
                entity.InputSchemaId, entity.OutputSchemaId, userContext, HttpContext.TraceIdentifier);
            ...
            _logger.LogDebug("Schema validation passed. Updating Processor entity with details. Id: {Id}, Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, UpdatedBy: {UpdatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogInformation("Successfully updated Processor entity. Id: {Id}, Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Schema validation failed updating Processor entity. Id: {Id}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict updating Processor entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error updating Processor entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult> Delete(string id)
    {
        ...
        try
        {
            ...
            {
                _logger.LogWarning("Processor deletion blocked due to step references. Id: {Id}, Message: {Message}, User: {User}, RequestId: {RequestId}",
                    guidId, ex.Message, userContext, HttpContext.TraceIdentifier);
                return Conflict(new
                {
                    error = "Processor has references",
            ...
            {
                _logger.LogError(ex, "Processor reference validation failed during deletion. Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                return StatusCode(503, new
                {
                    error = "Validation service unavailable",
            ...
            _logger.LogDebug("Deleting Processor entity. Id: {Id}, Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogInformation("Successfully deleted Processor entity. Id: {Id}, Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, User: {User}, RequestId: {RequestId}",
                guidId, existingEntity.Version, existingEntity.Name, existingEntity.InputSchemaId, existingEntity.OutputSchemaId, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<bool>> CheckInputSchemaReference(Guid schemaId)
    {
        ...
        _logger.LogInformation("Starting input schema reference check. SchemaId: {SchemaId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            {
                _logger.LogWarning("Invalid schema ID provided for input schema reference check. SchemaId: {SchemaId}, User: {User}, RequestId: {RequestId}",
                    schemaId, user, requestId);
            ...
            _logger.LogInformation("Input schema reference check completed. SchemaId: {SchemaId}, HasReferences: {HasReferences}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error checking input schema references. SchemaId: {SchemaId}, User: {User}, RequestId: {RequestId}",
                schemaId, user, requestId);
    ...
    public async Task<ActionResult<bool>> CheckOutputSchemaReference(Guid schemaId)
    {
        ...
        _logger.LogInformation("Starting output schema reference check. SchemaId: {SchemaId}, User: {User}, RequestId: {RequestId}",
            schemaId, user, requestId);
        ...
        try
        {
            if (schemaId == Guid.Empty)
            {
                _logger.LogWarning("Invalid schema ID provided for output schema reference check. SchemaId: {SchemaId}, User: {User}, RequestId: {RequestId}",
                    schemaId, user, requestId);
                return BadRequest("Schema ID cannot be empty");
            }
            ...
            _logger.LogInformation("Output schema reference check completed. SchemaId: {SchemaId}, HasReferences: {HasReferences}, User: {User}, RequestId: {RequestId}",
                schemaId, hasReferences, user, requestId);
        ...
        {
            _logger.LogError(ex, "Error checking output schema references. SchemaId: {SchemaId}, User: {User}, RequestId: {RequestId}",
                schemaId, user, requestId);
    ...
    public async Task<ActionResult<bool>> CheckProcessorExists(string processorId)
    {
        ...
        {
            _logger.LogWarning("Invalid GUID format for ProcessorId in exists check. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
                processorId, userContext, HttpContext.TraceIdentifier);
            return BadRequest($"Invalid GUID format: {processorId}");
        }

        _logger.LogInformation("Starting CheckProcessorExists request. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully processed CheckProcessorExists request. ProcessorId: {ProcessorId}, Exists: {Exists}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error processing CheckProcessorExists request. ProcessorId: {ProcessorId}, User: {User}, RequestId: {RequestId}",
                guidProcessorId, userContext, HttpContext.TraceIdentifier);
