...
public class UpdateProcessorCommandConsumer : IConsumer<UpdateProcessorCommand>
{
    ...
    public async Task Consume(ConsumeContext<UpdateProcessorCommand> context)
    {
        ...
        _logger.LogInformation("Processing UpdateProcessorCommand. Id: {Id}, Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, RequestedBy: {RequestedBy}",
        ...
        try
        {
            ...
            {
                _logger.LogWarning("Processor entity not found for update. Id: {Id}", command.Id);
            ...
            stopwatch.Stop();
            _logger.LogInformation("Successfully processed UpdateProcessorCommand. Id: {Id}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing UpdateProcessorCommand. Id: {Id}, Duration: {Duration}ms",
