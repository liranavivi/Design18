...
public class CreateProcessorCommandConsumer : IConsumer<CreateProcessorCommand>
{
    ...
    public async Task Consume(ConsumeContext<CreateProcessorCommand> context)
    {
        ...
        _logger.LogInformation("Processing CreateProcessorCommand. Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, ImplementationHash: {ImplementationHash}, RequestedBy: {RequestedBy}",
        ...
        try
        {
            ...
            stopwatch.Stop();
            _logger.LogInformation("Successfully processed CreateProcessorCommand. Id: {Id}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing CreateProcessorCommand. Version: {Version}, Name: {Name}, InputSchemaId: {InputSchemaId}, OutputSchemaId: {OutputSchemaId}, ImplementationHash: {ImplementationHash}, Duration: {Duration}ms",
