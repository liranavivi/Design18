...
public class OrchestratedFlowController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<OrchestratedFlowEntity>>> GetAll()
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} OrchestratedFlow entities. User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<object>> GetPaged([FromQuery] int page = 1, [FromQuery] int pageSize = 10)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved paged OrchestratedFlow entities. Page: {Page}/{TotalPages}, PageSize: {PageSize}, TotalCount: {TotalCount}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<OrchestratedFlowEntity>> GetById(string id)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved OrchestratedFlow entity. Id: {Id}, Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, User: {User}, RequestId: {RequestId}",
                entity.Id, entity.Version, entity.Name, entity.WorkflowId, string.Join(",", entity.AssignmentIds), userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<OrchestratedFlowEntity>> GetByCompositeKey(string version, string name)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved OrchestratedFlow entity by composite key. CompositeKey: {CompositeKey}, Id: {Id}, Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<IEnumerable<OrchestratedFlowEntity>>> GetByWorkflowId(string workflowId)
    {
        ...
        {
            _logger.LogWarning("Invalid GUID format provided. WorkflowId: {WorkflowId}, User: {User}, RequestId: {RequestId}",
                workflowId, userContext, HttpContext.TraceIdentifier);
            return BadRequest($"Invalid GUID format: {workflowId}");
        }

        _logger.LogInformation("Starting GetByWorkflowId OrchestratedFlow request. WorkflowId: {WorkflowId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} OrchestratedFlow entities by workflow ID. WorkflowId: {WorkflowId}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error retrieving OrchestratedFlow entities by workflow ID. WorkflowId: {WorkflowId}, User: {User}, RequestId: {RequestId}",
                guidWorkflowId, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving OrchestratedFlow entities");
        }
    }
    ...
    public async Task<ActionResult<IEnumerable<OrchestratedFlowEntity>>> GetByAssignmentId(string assignmentId)
    {
        ...
        {
            _logger.LogWarning("Invalid GUID format provided. AssignmentId: {AssignmentId}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} OrchestratedFlow entities by assignment ID. AssignmentId: {AssignmentId}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<IEnumerable<OrchestratedFlowEntity>>> GetByVersion(string version)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} OrchestratedFlow entities by version. Version: {Version}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<IEnumerable<OrchestratedFlowEntity>>> GetByName(string name)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully retrieved {Count} OrchestratedFlow entities by name. Name: {Name}, User: {User}, RequestId: {RequestId}",
    ...
    public async Task<ActionResult<bool>> CheckWorkflowReferences(string workflowId)
    {
        ...
        _logger.LogInformation("Starting CheckWorkflowReferences OrchestratedFlow request. WorkflowId: {WorkflowId}, User: {User}, RequestId: {RequestId}",
            guidWorkflowId, userContext, HttpContext.TraceIdentifier);
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully checked workflow references. WorkflowId: {WorkflowId}, HasReferences: {HasReferences}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error checking workflow references. WorkflowId: {WorkflowId}, User: {User}, RequestId: {RequestId}",
                guidWorkflowId, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<bool>> CheckAssignmentReferences(string assignmentId)
    {
        ...
        _logger.LogInformation("Starting CheckAssignmentReferences OrchestratedFlow request. AssignmentId: {AssignmentId}, User: {User}, RequestId: {RequestId}",
            guidAssignmentId, userContext, HttpContext.TraceIdentifier);
        ...
        try
        {
            ...
            _logger.LogInformation("Successfully checked assignment references. AssignmentId: {AssignmentId}, HasReferences: {HasReferences}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogError(ex, "Error checking assignment references. AssignmentId: {AssignmentId}, User: {User}, RequestId: {RequestId}",
                guidAssignmentId, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<OrchestratedFlowEntity>> Create([FromBody] OrchestratedFlowEntity entity)
    {
        ...
        _logger.LogInformation("Starting Create OrchestratedFlow request. CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for OrchestratedFlow creation. User: {User}, RequestId: {RequestId}",
                userContext, HttpContext.TraceIdentifier);
        ...
        if (!ModelState.IsValid)
        {
            ...
            _logger.LogWarning("Invalid model state for OrchestratedFlow creation. Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            _logger.LogInformation("Validating referential integrity for OrchestratedFlow creation. WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, User: {User}, RequestId: {RequestId}",
            ...
            if (!workflowExists)
            {
                _logger.LogWarning("Cannot create OrchestratedFlow - referenced workflow does not exist. WorkflowId: {WorkflowId}, User: {User}, RequestId: {RequestId}",
            ...
            if (!assignmentsExist)
            {
                _logger.LogWarning("Cannot create OrchestratedFlow - one or more referenced assignments do not exist. AssignmentIds: {AssignmentIds}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogDebug("Creating OrchestratedFlow entity with details. Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, CreatedBy: {CreatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            {
                _logger.LogError("MongoDB failed to generate ID for new OrchestratedFlowEntity. Version: {Version}, Name: {Name}, User: {User}, RequestId: {RequestId}",
                    entity.Version, entity.Name, userContext, HttpContext.TraceIdentifier);
                return StatusCode(500, "Failed to generate entity ID");
            }

            _logger.LogInformation("Successfully created OrchestratedFlow entity. Id: {Id}, Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict creating OrchestratedFlow entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error creating OrchestratedFlow entity. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<OrchestratedFlowEntity>> Update(string id, [FromBody] OrchestratedFlowEntity entity)
    {
        ...
        _logger.LogInformation("Starting Update OrchestratedFlow request. Id: {Id}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
            guidId, compositeKey, userContext, HttpContext.TraceIdentifier);

        if (entity == null)
        {
            _logger.LogWarning("Null entity provided for OrchestratedFlow update. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);
            return BadRequest("OrchestratedFlow entity cannot be null");
        }
        ...
        if (guidId != entity.Id)
        {
            _logger.LogWarning("ID mismatch in OrchestratedFlow update request. URL ID: {UrlId}, Entity ID: {EntityId}, User: {User}, RequestId: {RequestId}",
        ...
        if (!ModelState.IsValid)
        {
            var errors = ModelState.Values.SelectMany(v => v.Errors).Select(e => e.ErrorMessage);
            var errorMessage = string.Join("; ", errors);
            _logger.LogWarning("Invalid model state for OrchestratedFlow update. Id: {Id}, Errors: {Errors}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            // Validate referential integrity - check that WorkflowId and AssignmentIds exist
            _logger.LogInformation("Validating referential integrity for OrchestratedFlow update. WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, User: {User}, RequestId: {RequestId}",
                entity.WorkflowId, string.Join(",", entity.AssignmentIds), userContext, HttpContext.TraceIdentifier);

            var workflowExists = await _workflowValidationService.ValidateWorkflowExistsAsync(entity.WorkflowId);
            if (!workflowExists)
            {
                _logger.LogWarning("Cannot update OrchestratedFlow - referenced workflow does not exist. WorkflowId: {WorkflowId}, User: {User}, RequestId: {RequestId}",
                    entity.WorkflowId, userContext, HttpContext.TraceIdentifier);
                return BadRequest($"Referenced workflow with ID {entity.WorkflowId} does not exist");
            }
            ...
            if (!assignmentsExist)
            {
                _logger.LogWarning("Cannot update OrchestratedFlow - one or more referenced assignments do not exist. AssignmentIds: {AssignmentIds}, User: {User}, RequestId: {RequestId}",
                    string.Join(",", entity.AssignmentIds), userContext, HttpContext.TraceIdentifier);
                return BadRequest("One or more referenced assignments do not exist");
            }
            ...
            _logger.LogDebug("Updating OrchestratedFlow entity with details. Id: {Id}, Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, UpdatedBy: {UpdatedBy}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogInformation("Successfully updated OrchestratedFlow entity. Id: {Id}, Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogWarning(ex, "Duplicate key conflict updating OrchestratedFlow entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return Conflict(new { message = ex.Message });
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error updating OrchestratedFlow entity. Id: {Id}, Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                guidId, entity?.Version, entity?.Name, compositeKey, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult> Delete(string id)
    {
        ...
        try
        {
            ...
            _logger.LogDebug("Deleting OrchestratedFlow entity. Id: {Id}, Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, User: {User}, RequestId: {RequestId}",
            ...
            _logger.LogInformation("Successfully deleted OrchestratedFlow entity. Id: {Id}, Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, User: {User}, RequestId: {RequestId}",
                guidId, existingEntity.Version, existingEntity.Name, existingEntity.WorkflowId, string.Join(",", existingEntity.AssignmentIds), userContext, HttpContext.TraceIdentifier);
