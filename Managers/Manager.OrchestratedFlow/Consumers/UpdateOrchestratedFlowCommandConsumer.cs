...
public class UpdateOrchestratedFlowCommandConsumer : IConsumer<UpdateOrchestratedFlowCommand>
{
    ...
    public async Task Consume(ConsumeContext<UpdateOrchestratedFlowCommand> context)
    {
        ...
        _logger.LogInformation("Processing UpdateOrchestratedFlowCommand. Id: {Id}, Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, RequestedBy: {RequestedBy}",
        ...
        try
        {
            ...
            {
                _logger.LogWarning("OrchestratedFlow entity not found for update. Id: {Id}", command.Id);
            ...
            stopwatch.Stop();
            _logger.LogInformation("Successfully processed UpdateOrchestratedFlowCommand. Id: {Id}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing UpdateOrchestratedFlowCommand. Id: {Id}, Duration: {Duration}ms",
