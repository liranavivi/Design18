...
public class GetOrchestratedFlowQueryConsumer : IConsumer<GetOrchestratedFlowQuery>
{
    ...
    public async Task Consume(ConsumeContext<GetOrchestratedFlowQuery> context)
    {
        ...
        _logger.LogInformation("Processing GetOrchestratedFlowQuery. Id: {Id}, CompositeKey: {CompositeKey}",
        ...
        try
        {
            ...
            if (entity != null)
            {
                _logger.LogInformation("Successfully processed GetOrchestratedFlowQuery. Found entity Id: {Id}, Duration: {Duration}ms",
            ...
            {
                _logger.LogInformation("OrchestratedFlow entity not found. Id: {Id}, CompositeKey: {CompositeKey}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing GetOrchestratedFlowQuery. Id: {Id}, CompositeKey: {CompositeKey}, Duration: {Duration}ms",
                query.Id, query.CompositeKey, stopwatch.ElapsedMilliseconds);
