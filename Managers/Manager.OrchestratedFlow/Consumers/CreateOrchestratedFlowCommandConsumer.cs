...
public class CreateOrchestratedFlowCommandConsumer : IConsumer<CreateOrchestratedFlowCommand>
{
    ...
    public async Task Consume(ConsumeContext<CreateOrchestratedFlowCommand> context)
    {
        ...
        _logger.LogInformation("Processing CreateOrchestratedFlowCommand. Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, RequestedBy: {RequestedBy}",
        ...
        try
        {
            ...
            stopwatch.Stop();
            _logger.LogInformation("Successfully processed CreateOrchestratedFlowCommand. Id: {Id}, Duration: {Duration}ms",
        ...
        {
            stopwatch.Stop();
            _logger.LogError(ex, "Error processing CreateOrchestratedFlowCommand. Version: {Version}, Name: {Name}, WorkflowId: {WorkflowId}, AssignmentIds: {AssignmentIds}, Duration: {Duration}ms",
