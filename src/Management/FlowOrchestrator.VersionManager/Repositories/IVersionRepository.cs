...
{
    /// <summary>
    /// Defines the interface for the version repository.
    /// </summary>
    public interface IVersionRepository
    {
        ...
        /// <summary>
        /// Adds or updates version information for a specific component.
        /// </summary>
        /// <param name="versionInfo">The version information.</param>
        /// <returns>True if the version information was added or updated successfully; otherwise, false.</returns>
        Task<bool> AddOrUpdateVersionInfoAsync(VersionInfo versionInfo);

        /// <summary>
        /// Adds or updates a compatibility matrix for a specific component.
        /// </summary>
        /// <param name="compatibilityMatrix">The compatibility matrix.</param>
        /// <returns>True if the compatibility matrix was added or updated successfully; otherwise, false.</returns>
        Task<bool> AddOrUpdateCompatibilityMatrixAsync(CompatibilityMatrix compatibilityMatrix);
