...
namespace FlowOrchestrator.Recovery.Messaging
{
    ...
    public class ConsumerAdapter<TMessage> : MassTransit.IConsumer<TMessage>
        where TMessage : class
    {
        ...
        public async Task Consume(MassTransit.ConsumeContext<TMessage> context)
        {
            try
            {
                ...
                // Create a FlowOrchestrator ConsumeContext from the MassTransit ConsumeContext
                var adaptedContext = new ConsumeContext<TMessage>(
                    context.Message,
