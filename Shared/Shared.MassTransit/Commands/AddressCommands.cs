...
/// <summary>
/// Query to retrieve the configuration of a address entity.
/// </summary>
public class GetAddressConfigurationQuery
{
    /// <summary>
...
/// <summary>
/// Response for the GetAddressConfigurationQuery.
/// </summary>
public class GetAddressConfigurationQueryResponse
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the address configuration.
    /// </summary>
